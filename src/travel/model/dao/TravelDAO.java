...
public class TravelDAO {
	...
	public ArrayList<Driver> selectList(Connection conn,String sido,String packageDate){
		...
		String query = "SELECT * FROM DRIVER D FULL OUTER JOIN TRAVEL T ON D.DRIVER_ID = T.DRIVER_ID WHERE D.DRIVER_CHECK ='1' AND D.DRIVER_AREA = ? AND T.PACKAGE_TRAVELDATE != ?";
